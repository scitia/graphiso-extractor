...
bool FilesystemUtils::create_directory(std::filesystem::path path, std::string directory_name) const
{
...
bool FilesystemUtils::create_directories(std::filesystem::path path) const
{
