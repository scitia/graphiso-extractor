...
const std::string FileIO::DEFAULT_BASE_FILENAME = "bgs";
const std::string FileIO::DEFAULT_CONGRUENT_FILENAME = "cgs";
const std::string FileIO::DEFAULT_GROUND_FILENAME = "gtr";